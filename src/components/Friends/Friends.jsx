    ...
    <>
      <div className=" w-[32%] h-[355px] xxl:h-[489px] pt-5 pb-3 pl-5 pr-[22px] rounded-20px shadow-CardShadow">
        ...
        <ul className=" h-[86%] overflow-y-auto">
          ...
          <li className="py-3 flex justify-between items-center border-b-[1px] border-solid border-[#00000040]">
            <div className="flex items-center">
              <div className="relative mr-3.5  after:content-[''] after:h-[15px] after:w-[15px] after:bg-[#00FF75] after:absolute lg:after:bottom-0 xl:after:bottom-0 lg:after:right-0 xl:after:right-0  after:rounded-full after:border-solid after:border-white after:border-2">
                <img
                  className="w-[54px] h-[54px] rounded-full object-cover"
                  src={friendsImg2}
                  alt="friendsImg2"
